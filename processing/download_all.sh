...
#Bremen ARTIST 6.25k
wget -A "5.4.nc" -r -nc -nd -np -nH -nv -e robots=off seaice.uni-bremen.de/data/amsr2/asi_daygrid_swath/s6250/netcdf/ -P /g/data/jk72/MIZ/Bremen/6km/netcdf

for y in $(seq 2012 20$(date +%y));
do for m in jan feb mar apr may jun jul aug sep oct nov dec;
do wget -A "5.4.tif" -r -nc -nd -np -nH -nv -e robots=off seaice.uni-bremen.de/data/amsr2/asi_daygrid_swath/s6250/$y/$m/Antarctic/ -P /g/data/jk72/MIZ/Bremen/6km/geotiff;
done;
done
...
for y in $(seq 2012 20$(date +%y));
do for m in jan feb mar apr may jun jul aug sep oct nov dec;
do wget -A "5.4.tif" -r -nc -nd -np -nH -nv -e robots=off seaice.uni-bremen.de/data/amsr2/asi_daygrid_swath/s3125/$y/$m/Antarctic3125/ -P /g/data/jk72/MIZ/Bremen/3km/;
done;
done

#OCCCI Ocean Colour
wget -r -cN -nd --user oc-cci-data --password ELaiWai8ae ftp://ftp.rsg.pml.ac.uk/occci-v6.0/geographic/netcdf/monthly/chlor_a/ -P /g/data/jk72/MIZ/OCCCIv6.0
...
#IBSCO Bathymetry
wget https://download.pangaea.de/dataset/937574/files/IBCSO_v2_ice-surface.nc -P /g/data/jk72/MIZ/IBCSO
