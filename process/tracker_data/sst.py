#From the list of provided netcdf files, mkae geotiffs of the SST in south polar stereo projection
...
try:
    ...
    START_YEAR='1980'
    datetimes_xr=sst_monthly_da.sel(time=slice('1980','2050')).time
